  ...
  return `Return this exact JSON structure:
{
  ...
  "detailedReport": "string - A VERY comprehensive, highly detailed architectural markdown report (aim for roughly 10,000 words, 8,000 to 12,000 is acceptable). Explain exactly what this program does and how it works end-to-end. Break down the entire architecture, design patterns, security mechanisms, API communication, data flow, deep component relationship analysis, and theoretical foundations. Explain everything in extreme detail with formatting.",
  "workflowSteps": [
    {
      "step": 1,
      "title": "string",
